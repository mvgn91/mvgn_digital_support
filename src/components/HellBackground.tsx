...
const fragmentShaderSource = `
  ...
  // Plata y Rojo palette
  #define COLOUR_1 vec4(uColor.rgb, 1.0)
  #define COLOUR_2 vec4(0.86, 0.15, 0.15, 1.0)
  #define COLOUR_3 vec4(0.12, 0.03, 0.03, 1.0)
...
function HellBackground({
  ...
  return (
    <div className={className} style={{ width: "100%", height: "100%", overflow: "hidden", position: "relative" }}>
      <canvas
        ref={canvasRef}
        style={{
          position: "absolute",
